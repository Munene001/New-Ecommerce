        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div className="bg-gradient-to-r from-red-500 to-rose-600 px-6 py-8 text-center">
              ...
              <p className="text-red-50 text-sm mt-1">{statusMessage}</p>
            </div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div className="bg-gradient-to-r from-yellow-500 to-orange-500 px-6 py-8 text-center">
              ...
              <h1 className="text-2xl font-bold text-white">
                {tooManyAttempts ? "Too Many Attempts" : "Payment Cancelled"}
              </h1>
              <p className="text-yellow-50 text-sm mt-1">{statusMessage}</p>
            </div>
            ...
            <MessageDisplay
              ...
              description={
                statusMessage || "You cancelled the payment. You can try again."
              }
            />
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 border border-blue-200 dark:border-blue-800">
                    <div className="flex gap-3">
                      ...
                      <p className="text-sm text-blue-800 dark:text-blue-300">
                        You can retry the payment ({retryCount}/3 attempts used).
                      </p>
                    </div>
                  </div>
                </div>
