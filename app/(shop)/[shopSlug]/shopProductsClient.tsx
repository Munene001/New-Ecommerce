...
import ActiveFiltersChips from "./components/activeFiltersChip";
...
export default function ShopProductsClient() {
  ...
  useEffect(() => {
    ...
    // Only scroll on desktop (lg breakpoint and above)
  ...
  return (
    <div>
      ...
      {/* Mobile filter bar */}
      <div
        className="lg:hidden px-4 py-5 font-[Poppins] cursor-pointer"
      ...
      <div className="px-4 pb-8 ">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 min-w-0">
            {/* Active filters chips - now using separate component */}
            <ActiveFiltersChips
              activeFilters={activeFilters}
              shop={shop}
